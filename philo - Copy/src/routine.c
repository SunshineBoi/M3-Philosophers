...
/*   Updated: 2026/06/24 17:32:29 by kong             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*philo_routine(void *data)
{
	...
	while (get_stopflag(app) != 1)
	{
		...
		// 	// print thinking
		// 	printf_action(philo, get_timestamp(app), ACT_THINK);
		// 	long time_since_ate = get_timestamp(app) - get_lasteatentime(app, philo->id);
		// 	long think_time = (app->t_die / 2) - time_since_ate;
		// 	if (think_time > 0)
		// 		precise_sleep(app, think_time);
		// }
		// start eating
